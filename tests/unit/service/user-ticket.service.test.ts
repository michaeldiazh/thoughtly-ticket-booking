...
import { buildInsertUserTicketQuery } from '../../../src/service/query/user-ticket/insert-user-ticket.query';
import { buildGetUserTicketQuery } from '../../../src/service/query/user-ticket/get-user-ticket.query';
import { buildUpdateTicketRemainingQuery } from '../../../src/service/query/ticket/update-ticket-remaining.query';
...
jest.mock('../../../src/service/query/user-ticket/insert-user-ticket.query');
jest.mock('../../../src/service/query/user-ticket/get-user-ticket.query');
jest.mock('../../../src/service/query/ticket/update-ticket-remaining.query');
